...
[{{< fa tablet-screen-button >}}]{.imp} Was ist guter digital gestützer Unterricht?\
<br>

. . .

<center>[{{< fa list-check >}}]{.imp} Übung: SAMR Modell</center>
...
* Die Technologieintegration stellt eher eine notwendige als eine hinreichende Bedingung für Unterrichtsqualität dar: 
    ...
    * kann gleichzeitig nicht von jedem Technolgieeinsatz höherer Integration (Augmentation, Modification, Redefinition) ein Vorteil erwartet werden.
